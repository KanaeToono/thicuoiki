...
public class ThongBaoFragment extends Fragment {
    private static String TAG = ThongBaoFragment.class.getSimpleName();
   ...
   //SimpleDateFormat format = new SimpleDateFormat("EEE MMM dd yyyy hh:mm aaa");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.thongbaofragment, container, false);
        //cofig show image
        Log.d(TAG, " ON CREATE TIEU DIEM FRAGMENT");
        ...
        //kiem tra
         if(mRssItemHelper.getCountThongBao() == 0 && mNetworkUtils.isConnectingToInternet()){
             ...
             mTieuDiemAdapter = new TieuDiemAdapter(getActivity(), mRssItemHelper.getAllThongBao(), onItemClickCallback);
    ...
    public class ReadXmlPullParse extends AsyncTask<String, Integer, List<RssItem>> {
        ...
        public void onPostExecute(List<RssItem> rssItems) {
            ...
            for(int i=0 ; i <rssItems.size(); i++){
                mRssItemHelper.addNewThongBao(rssItems.get(i));
            }
...
//            swipeMenuListView.setAdapter(mReadNewsListAdapter);
    ...
    private OnItemClickListener.OnItemClickCallback onItemClickCallback = new OnItemClickListener.OnItemClickCallback() {
        ...
        public void onItemClicked(View view, int position) {
            ...
            mArrayList = mRssItemHelper.getAllThongBao();
