 ...
 */
public class DoanThanhNienFragment extends Fragment {
    private static String TAG = DoanThanhNienFragment.class.getSimpleName();
   ...
   //SimpleDateFormat format = new SimpleDateFormat("EEE MMM dd yyyy hh:mm aaa");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.doanthanhnienfragment, container, false);
        //cofig show image
        Log.d(TAG, " ON CREATE TIEU DIEM FRAGMENT");
