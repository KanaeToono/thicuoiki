 ...
 */
public class SortPiorityTask extends Fragment {
    private static String TAG = SortPiorityTask.class.getSimpleName();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d(TAG, " ON CREATE SORT PIORITY  TASK");
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.sort_day_piority_task_frag, container, false);
        ...
        mArrayList = mTaskDatabaseAdapter.sortPiorityTask();
