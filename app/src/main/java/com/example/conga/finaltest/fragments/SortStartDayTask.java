 ...
 */
public class SortStartDayTask extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d(TAG, " ON CREATE SORT START DAY TASK");
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.sort_day_start_task_frag, container, false);
        ...
        mArrayList = mTaskDatabaseAdapter.sortStartDateTask();
